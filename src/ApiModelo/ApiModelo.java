...
public class ApiModelo {
    ...
    /**
     * Retorna el cuerpo de la respuesta como String JSON.
     * Usado por el Servlet para procesar los datos.
     */
    public String getBody() {
        if (this.respuesta_api != null) {
            return this.respuesta_api.body();
        }
        return "[]";
    }
    ...
    public int getStatusCode() {
        if (this.respuesta_api != null) {
            return this.respuesta_api.statusCode();
        }
        return -1;
    }
    ...
    public void imprimir_info() {
        ...
        System.out.println("El código de estado es: " + this.respuesta_api.statusCode());
    }
    ...
    public void info_respuesta() {
        try {
            ...
            for (int i = 0; i < array_json.length(); i++) {
                ...
                // La API de Colombia usa "name" en lugar de "title"
                String nombre = "";
                if (obj_info.has("name")) {
                    nombre = obj_info.getString("name");
                }

                System.out.println("El id: " + id + " - el nombre: " + nombre);
            }
